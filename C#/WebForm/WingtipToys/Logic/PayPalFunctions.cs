...
public class NVPAPICaller
{
    ...
    public string APIUsername = "bensong2017-facilitator_api1.hotmail.com";
    private string APIPassword = "YRMXVUFLES7BPAUT";
    private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31A6HJJMVJfq76.LRh7x3EF3aCcvPw";
    ...
    public string HttpCall(string NvpRequest)
    {
        ...
        {
            //throw new Exception("msg" + e.Message.ToString());
