...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <section>
        ...
        <asp:ListView ID="productList" runat="server" DataKeyNames="ProductID" GroupItemCount="3"
            ItemType="WingtipToys.Models.Product" SelectMethod="GetPros">
            <EmptyDataTemplate>
                <table>
                    <tr>
                            ...
                            <td>
                                <a href="<%#:GetRouteUrl("ProductbyNameRoute",new { productName=Item.ProductName})  %>">
                                    <img src="/Catalog/Images/Thumbs/<%#:Item.ImagePath %>"
                                        width="100" height="75" style="border: solid"  alt="pic"/>
                                </a>
                            </td>
                        </tr>
